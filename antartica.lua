...
local checkpoints = {
    --camp1
    Vector3.new(-6041.79, -159, -59),      --  bc water
    Vector3.new(-5825.33, -155, -41),      -- 1
    Vector3.new(-5691.97, -140.55, -123),  -- 2
    Vector3.new(-5477.35, -141.20, -172),  -- 3
    Vector3.new(-5301.83, -103.63, -232),  -- 4
    Vector3.new(-5198.83, -94.66, -66.2),  -- 5
    Vector3.new(-4924.24, -121.50, -90.4), -- 6
    Vector3.new(-4366.94, 98.74, -222.8),  -- 7
    Vector3.new(-4188.29, 112.02, -171.5), -- tali
    Vector3.new(-3792.66, 161.21, 106.5),  --
    Vector3.new(-3900.66, 169.92, 235.5),  -- jembtn
    Vector3.new(-3778.66, 212.74, 259.5),  -- jembtn
    Vector3.new(-3720.56, 225.02, 235.2),  -- camp1
    Vector3.new(-3716.83, 229.04, 264.5),  -- camp1 water
}
